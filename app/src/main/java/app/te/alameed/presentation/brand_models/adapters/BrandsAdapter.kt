...
import app.te.alameed.databinding.ItemBrandBinding
import app.te.alameed.domain.brand_models.entity.BrandModels
import app.te.alameed.presentation.base.extensions.openFullScreenExtension
import app.te.alameed.presentation.brand_models.listeners.BrandModelsEventListeners

class BrandsAdapter(val brandModelsEventListeners: BrandModelsEventListeners) :
    PagingDataAdapter<BrandModels, BrandsAdapter.ViewHolder>(differCallback) {
    ...
    inner class ViewHolder(itemView: View) :
        ...
        lateinit var itemLayoutBinding: ItemBrandBinding
