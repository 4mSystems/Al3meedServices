...
import app.te.alameed.presentation.base.utils.images.PhotoFullPopupWindow
...
fun ImageView.openFullScreenExtension(imageUrl: String?) {
    PhotoFullPopupWindow(context, this, imageUrl, null)
}

@BindingAdapter("app:openFullScreen")
fun openFullScreen(imageView: ImageView, imageUrl: String?) {
    imageView.setOnClickListener {
        Log.e("openFullScreen", "openFullScreen: ")
        PhotoFullPopupWindow(imageView.context, imageView, imageUrl, null)
    }
}
